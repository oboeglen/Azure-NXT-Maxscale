...
> `autoheal` et `whiteboard` ne publient pas de tags versionnés exploitables sur Docker Hub — ils sont épinglés par digest SHA256, ce qui garantit la même reproductibilité.
