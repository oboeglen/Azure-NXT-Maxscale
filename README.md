...
### Option 2 — Firewall via le panneau OVH

OVH propose un pare-feu réseau (Network Firewall) directement sur l'IP failover dans l'espace client, sans modifier le VPS. Configure-le pour n'autoriser que les ports 22, 80 et 443 en TCP.

### Option 3 — Fail2ban (protection brute-force SSH)

Fail2ban surveille les logs SSH et bannit automatiquement les IPs après plusieurs tentatives échouées. Complémentaire au firewall.
