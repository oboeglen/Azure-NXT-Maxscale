...
[![Version](https://img.shields.io/badge/version-2.1.16-blue)](https://github.com/oboeglen/Azure-NXT-Maxscale)
...
| `IMG_COLLABORA` | `collabora/code` | digest SHA256 (v25.04.9.4) |
| `IMG_AUTOHEAL` | `willfarrell/autoheal` | digest SHA256 |
| `IMG_WHITEBOARD` | `ghcr.io/nextcloud-releases/whiteboard` | digest SHA256 |

> `collabora/code`, `autoheal` et `whiteboard` ne publient pas de tags versionnés exploitables sur Docker Hub — ils sont épinglés par digest SHA256, ce qui garantit la même reproductibilité.
