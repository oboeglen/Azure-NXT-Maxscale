#!/usr/bin/env bash
# =============================================================================
# deploy.sh — Azure NXT Maxscale — Déployeur automatique v2.1.16
...
IMG_COLLABORA="collabora/code@sha256:fe49c08c27e102c1877ad4ef2ac1a7bd8ccd2dfaa6641d4533389c204a92bb88"
...
show_banner() {
  ...
  for line in \
    ...
    "   ██╔══██║ ███╔╝  ██║   ██║██╔══██╗██╔══╝" \
    "   ██║  ██║███████╗╚██████╔╝██║  ██║███████╗" \
    "        NXT Maxscale — Déployeur automatique v2.1.16"; do
    printf "  ${C_BCYAN}║${C_RESET}"
    _rpad "$line" "$inner"
    printf "${C_BCYAN}║${C_RESET}\n"
  done
